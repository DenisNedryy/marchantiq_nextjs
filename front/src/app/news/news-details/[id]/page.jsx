...
import Script from "next/script"; // important : import par défaut
import getNewsJsonLd from "../../../components/utils/getNewsJsonLd";

// METADATA DYNAMIQUES POUR UNE ACTUALITÉ
export async function generateMetadata({ params }) {
    // tu peux faire comme ça si tu veux rester cohérent avec le reste
